...
namespace GestcomWF.DataAccess
{
    public abstract class DataAdo
    {
        ...
        {
            string connectionString = @"Provider= Microsoft.ACE.OLEDB.12.0;Data Source=E:\Dossier Dev\Informatique\Bases\TB_GestCom_Bis (1).accdb;Persist Security Info=False;";
